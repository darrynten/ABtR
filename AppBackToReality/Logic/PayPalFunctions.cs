...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:65129/Default";
        string cancelURL = "http://localhost:65129/Default";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "AppBackToReality";
        ...
        using (AppBackToReality.Logic.ShoppingCartActions myCartOrders = new AppBackToReality.Logic.ShoppingCartActions())
        {
            List<CartItem> myOrderList = myCartOrders.GetCartItems();

            for (int i = 0; i < myOrderList.Count; i++)
            {
                encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].Screen.ScreenName.ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Screen.UnitPrice.ToString();
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
           // AppBackToReality.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
